//Novo script para a forca
	...
	document.getElementById("letra-user").focus();
	for(i = 0; i < palavra.length; i++){
		var container = document.getElementById("container-forca");
	...
	var erros = 0;
	function insere(){
		var x = document.getElementById("letra-user").value;
		...
		const campo = document.getElementById("letra-user");
		campo.value = '';
